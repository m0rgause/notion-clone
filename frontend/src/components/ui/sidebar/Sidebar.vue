  ...
  >
    ...
    <div class="flex-1 overflow-y-auto">
      <div class="flex flex-col gap-2 p-4">
        ...
        >
          <IconPlus class="h-4 w-4" :class="{ 'animate-spin': noteStore.loading }" />
          <span 
        ...
        <div class="flex items-center gap-2" v-if="!isCollapsed">
          <div class="relative flex-1">
            <Input
              ...
              class="pr-8"
            />
            <IconSearch class="absolute right-2 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
          </div>
        </div>
      </div>
          ...
          >
            ...
            <DropdownMenu v-if="!isCollapsed">
              ...
              <DropdownMenuContent align="end" class="w-40">
                <DropdownMenuItem @click="deleteNote(note.id, $event)" class="text-destructive">
